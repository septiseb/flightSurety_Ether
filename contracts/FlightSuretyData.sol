...
contract FlightSuretyData {
     ...
     */
    constructor(address firstAirlineRegister) public {
    ...
    function isOpratingAirline(address airline) public view returns (bool) {
        return airlines[airline].isOperating;
    }
    ...
    function registerAirline(address contractAddress) external {
        require(isAirline(contractAddress), "It is already registered");
        airlines[contractAddress] = airlineProfile(true, false, 0); 
    }
